...
import com.krld.model.flora.Brush;
import com.krld.model.flora.Fir;
...
public class WorldGenerator {
    ...
    public static void generateUnits(ArrayList<Located> units, int[][] tileMap, ArrayList<Moveable> moveables, GameState gameState) {
        WorldGenerator.gameState = gameState;
        for (int x = 0; x < tileMap.length; x++) {
            for (int y = 0; y < tileMap.length; y++) {
                int realX = x * 32 - 1;
                int realY = y * 32 - 1;
